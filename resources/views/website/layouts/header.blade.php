...
#grad1 {
  ...
  background-image: radial-gradient(circle farthest-side,#3873c8,#0f3870);
}
</style>
<header id="grad1">
   <div class="header-area" id="grad1">
                  ...
                  <div class="main-menu  d-none d-lg-block">
                     <nav>
                        <ul id="navigation">
                           ...
                           @endif
                           <li><a class="{{ is_active_menu('order_page') }}" href="{{ route('order_page') }}">Order Now</a></li>
                        </ul>
                     </nav>
                  </div>
               </div>
